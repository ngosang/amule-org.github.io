...
weight: 10
description: >
  First run, bandwidth configuration, connecting to ED2K and Kademlia networks,
  searching for files, and managing downloads.
---
...
![Bandwidth limits dialog](/docs/assets/bandwidth_limits.png)
...
![Empty server list](/docs/assets/serverlist_empty.png)
...
![Server list populated via ED2K](/docs/assets/serverlist_ed2k.png)
...
![Kademlia network page](/docs/assets/serverlist_kad.png)
...
![Search dialog](/docs/assets/search_dialog.png)
...
![Search results](/docs/assets/search_results.png)
...
![Transfer queue](/docs/assets/transfers_queue.png)
...
![Reload shared files button](/docs/assets/reload_button.png)

**2. Add shared directories in Preferences**

Click **Preferences → Directories**:

![Preferences — Directories page](/docs/assets/prefs_directories.png)
