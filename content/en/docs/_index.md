...
weight: 1
description: >
  aMule is a free, open-source, multi-platform peer-to-peer file-sharing client
  for the eD2k (eDonkey2000) and Kademlia (Kad) networks.
---
...
- [Getting Started](user-guide/getting-started/) — first run, configuration, searching and downloading
