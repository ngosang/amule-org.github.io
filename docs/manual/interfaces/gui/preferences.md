...
| **Slot Allocation** | Target speed per allocated upload slot (kB/s). Default: 10. aMule derives the number of upload slots from it — see [Bandwidth & Upload Slots](../../configuration/bandwidth-slots.md). |
