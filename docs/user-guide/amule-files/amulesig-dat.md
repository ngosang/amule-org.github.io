...
| 5 | Client ID type | `H` ([High ID](../../ed2k/high-id-low-id.md)), `L` ([Low ID](../../ed2k/high-id-low-id.md)), or `0` | `0` when disconnected, connecting, or cleanly closed |
...
| 4 | Server port | `4661` | |
| 5 | ID type | `H` | [High ID](../../ed2k/high-id-low-id.md) |
