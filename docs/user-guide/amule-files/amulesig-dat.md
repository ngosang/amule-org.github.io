...
`amulesig.dat` is aMule's status signature file. It is written periodically by aMule to inform external applications — such as [CAS](./cas.md), [wxCAS](../amule-components/), and IRC bots — of the current state of the running aMule instance.
