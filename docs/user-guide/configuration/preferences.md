...
| **Filtering Level** | Select the filtering level. See [IPFilter](ipfilter.md) for details. |
...
See the dedicated [Events](events.md) page for a full description of event types, variables, and example scripts.
