...
![Diálogo de límites de ancho de banda](../assets/bandwidth_limits.png)
...
![Lista de servidores vacía](../assets/serverlist_empty.png)
...
![Lista de servidores ED2K poblada](../assets/serverlist_ed2k.png)
...
![Página de red Kademlia](../assets/serverlist_kad.png)
...
![Diálogo de búsqueda](../assets/search_dialog.png)
...
![Resultados de búsqueda](../assets/search_results.png)
...
![Cola de transferencias](../assets/transfers_queue.png)
...
![Botón recargar archivos compartidos](../assets/reload_button.png)

**2. Añadir directorios compartidos en Preferencias**

Haz clic en **Preferencias → Directorios**:

![Preferencias — página de directorios](../assets/prefs_directories.png)
