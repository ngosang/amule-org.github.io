...
![Bandwidth limits dialog](../assets/bandwidth_limits.png)
...
![Empty server list](../assets/serverlist_empty.png)
...
![Server list populated via ED2K](../assets/serverlist_ed2k.png)
...
![Kademlia network page](../assets/serverlist_kad.png)
...
![Search dialog](../assets/search_dialog.png)
...
![Transfer queue](../assets/transfers_queue.png)
...
![Reload shared files button](../assets/reload_button.png)

**2. Add shared directories in Preferences**

Click **Preferences → Directories**:

![Preferences — Directories page](../assets/prefs_directories.png)
